  ...
  return (
    <div>
      ...
      <p>
        ...
        <a href="http://launchday.netlify.com"> http://launchday.netlify.com</a>
      ...
      <ol type="a">
        ...
        <li>
          ...
          restrictions and may be terminated by Launchday at any time. Upon
      ...
      <ol type="a">
        <li>
          The materials on Launchday's website are provided on an 'as is' basis.
          Launchday makes no warranties, expressed or implied, and hereby
      ...
      <h3>4. Limitations</h3>
      <p>
        In no event shall Launchday or its suppliers be liable for any damages
        (including, without limitation, damages for loss of data or profit, or
        due to business interruption) arising out of the use or inability to use
        the materials on Launchday's website, even if Launchday or a Launchday
      ...
      <p>
        The materials appearing on Launchday's website could include technical,
        typographical, or photographic errors. Launchday does not warrant that
        any of the materials on its website are accurate, complete or current.
        Launchday may make changes to the materials contained on its website at
        any time without notice. However Launchday does not make any commitment
        to update the materials.
      </p>
      <h3>6. Links</h3>
      <p>
        Launchday has not reviewed all of the sites linked to its website and is
        not responsible for the contents of any such linked site. The inclusion
        of any link does not imply endorsement by Launchday of the site. Use of
        any such linked website is at the user's own risk.
      </p>
      <h3>7. Modifications</h3>
      <p>
        Launchday may revise these terms of service for its website at any time
      ...
      <p>
        ...
        with the laws of Austria and you irrevocably submit to the exclusive
