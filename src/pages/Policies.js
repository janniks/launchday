...
const Terms = () => {
  return (
    <div>
      ...
      <p>
        Your privacy is important to us. It is Launchday's policy to respect
      ...
      <p>
        <strong>Launchday Data Controller</strong>
        <br />
        Jannik Siebert
        <br />
        launchday@janniks.com
      </p>
      <p>
        <strong>Launchday Data Protection Officer</strong>
        <br />
        Jannik Siebert
        <br />
        launchday@janniks.com
      </p>
      <p>This policy is effective as of 24 October 2019.</p>
      <h2>Cookie Policy</h2>
      <p>
        We use cookies to help improve your experience of
        <a href="http://launchday.netlify.com"> http://launchday.netlify.com</a>
        . This cookie policy is part of Launchday's privacy policy, and covers
      ...
      <p>
        ...
        (like language and timezone settings). With this information, websites
        can provide you with customised, enhanced or optimised content and
        services. These cookies may be set by the website you’re visiting
        (first-party) or by third-party service. We do not use this type of
        cookie on our site.
      </p>
      ...
      <p>
        ...
        that use the same third-party service. We do not use this type of cookie
        on our site.
      </p>
